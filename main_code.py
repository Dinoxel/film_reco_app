...
l10n_fr = {
    ...
    'title': 'App de recommandation de films',
    'define_movie': "Écrivez le nom d'un film pour obtenir des recommandations",
    ...
    'movie_selector': 'Sélectionner le film désiré dans la liste suivante. Défaut : {} ({})',
    "genre_title": "Titre",
